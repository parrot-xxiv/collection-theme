...
<head>
	...
	<meta name="description" content="WordPres Collections by Eldren Par ">
						...
						<div
							...
							<div class="p-6 transition-colors duration-300 group-hover:bg-white/40 dark:group-hover:bg-slate-800/40">
								...
								<a href="<?php echo esc_url($link); ?>"
									...
									View Project
									<svg class="inline-block" fill="currentColor" width="14px" height="14px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
